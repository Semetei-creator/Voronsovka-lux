...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ru: {
    ...
    formEmail: "Электронная почта пациента",
    formEmailPlaceholder: "patient@example.com",
  ...
  kg: {
    ...
    formEmail: "Бейтаптын электрондук дареги (Email)",
    formEmailPlaceholder: "patient@example.com",
  ...
  en: {
    ...
    formEmail: "Patient Email Address",
    formEmailPlaceholder: "patient@example.com",
